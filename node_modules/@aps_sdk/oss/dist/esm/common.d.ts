 ...
 * @export
 */
export declare const createRequestFunction: (axiosArgs: RequestArgs, sdkManager?: SdkManager) => <T = unknown, R = AxiosResponse<T>>() => Promise<any>;
/**
 *
 * @export
 */
export declare const createRequestFunctionOss: (axiosArgs: RequestArgs, sdkManager?: SdkManager) => <T = unknown, R = AxiosResponse<T>>() => Promise<any>;
