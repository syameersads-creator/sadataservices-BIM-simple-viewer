...
const BucketsApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        createBucket: (accessToken_1, policyKey_1, region_1, ...args_1) => __awaiter(this, [accessToken_1, policyKey_1, region_1, ...args_1], void 0, function* (accessToken, policyKey, region, options = {}) {
            // verify required parameter 'region' is not null or undefined
            (0, common_1.assertParamExists)('createBucket', 'region', region);
            ...
            if (region != null) {
                localVarHeaderParameter['x-ads-region'] = typeof region === 'string'
                    ? region
...
const BucketsApiFp = function (sdkManager) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createBucket(accessToken, policyKey, region, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.createBucket(accessToken, policyKey, region, options);
...
class BucketsApi extends base_1.BaseApi {
    ...
    createBucket(accessToken, policyKey, region, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.BucketsApiFp)(this.sdkManager).createBucket(accessToken, policyKey, region, options);
