...
const InformationalApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        getFormats: (accessToken_1, ifModifiedSince_1, acceptEncoding_1, ...args_1) => __awaiter(this, [accessToken_1, ifModifiedSince_1, acceptEncoding_1, ...args_1], void 0, function* (accessToken, ifModifiedSince, acceptEncoding, options = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error.response) {
                    ...
                    throw new base_1.ModelDerivativeApiError(`getFormats Request failed with status : ${error.response.status} and error message: ${errorMessage}`, error);
                }
